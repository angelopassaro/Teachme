  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__get__passpartout
         * @methodOf lbServices.Student
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__create__passpartout
         * @methodOf lbServices.Student
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__update__passpartout
         * @methodOf lbServices.Student
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__destroy__passpartout
         * @methodOf lbServices.Student
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__findById__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Find a related item by id for notification.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         *
         *  - `fk` – `{*}` - Foreign key for notification
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * </em>
         */
        "prototype$__findById__notification": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/students/:id/notification/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__destroyById__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Delete a related item by id for notification.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        "prototype$__destroyById__notification": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/students/:id/notification/:fk",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__updateById__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Update a related item by id for notification.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        "prototype$__updateById__notification": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/students/:id/notification/:fk",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__get__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Queries notification of student.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        "prototype$__get__notification": {
          isArray: true,
          url: urlBase + "/students/:id/notification",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__create__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Creates a new instance in notification of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * </em>
         */
        "prototype$__create__notification": {
          url: urlBase + "/students/:id/notification",
          method: "POST"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__delete__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Deletes all notification of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         * This method returns no data.
         */
        "prototype$__delete__notification": {
          url: urlBase + "/students/:id/notification",
          method: "DELETE"
        },
        ...
        /**
         * @ngdoc method
         * @name lbServices.Student#prototype$__count__notification
         * @methodOf lbServices.Student
         *
         * @description
         *
         * Counts notification of student.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - User id
         ...
         *  - `count` – `{number=}` - 
         */
        "prototype$__count__notification": {
          url: urlBase + "/students/:id/notification/count",
          method: "GET"
        },
         ...
         */
        "send": {
          url: urlBase + "/students/re-email",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Student#notify
         * @methodOf lbServices.Student
         *
         * @description
         *
        ...
        // INTERNAL. Use Feedback.FromTo() instead.
        "::get::feedback::FromTo": {
          url: urlBase + "/feedbacks/:id/FromTo",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    */
    R.modelName = "Feedback";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Feedback#FromTo
         * @methodOf lbServices.Feedback
         *
         * @description
         *
         * Fetches belongsTo relation FromTo.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.FromTo = function() {
          var TargetResource = $injector.get("Student");
          var action = TargetResource["::get::feedback::FromTo"];
          return action.apply(R, arguments);
        };
